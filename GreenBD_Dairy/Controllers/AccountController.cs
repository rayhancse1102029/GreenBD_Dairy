...
using GreenBD_Dairy.Models.AccountViewModels;
using GreenBD_Dairy.Services;
...
namespace GreenBD_Dairy.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        [AllowAnonymous]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Register(RegisterViewModel model, string username, string returnUrl = null)
        {
            ViewData["ReturnUrl"] = returnUrl;

            if (!string.IsNullOrEmpty(username) && !string.IsNullOrEmpty(model.Password))
            {
