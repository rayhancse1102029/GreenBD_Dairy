...
namespace GreenBD_Dairy.Controllers
{
    ...
    public class PaymentMethodsController : Controller
    {
        ...
        public PaymentMethodsController(GreenBD_DairyContext context)
        {
            _context = context;
        }
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("PaymentMethodId,PaymentMethodName,OwnerSignature,EntryDate")] PaymentMethod paymentMethod)
        {
